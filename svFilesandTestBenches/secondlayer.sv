module secondlayer(
	...
	input start,
	output logic signed [26:0] layer_2_out [9:0],
	output logic complete = 0
);
	logic signed [7:0]  weights2 [319:0];
	logic signed [19:0] biases2 [9:0];       // Widened to 20 bits
	logic signed [26:0] answer [9:0];
	...
	logic [14:0] index = (currNeuron * 32) + currPixel;
